...
export default function EventDrawer({
  ...
  function validate(x) {
    ...
    if (x.endDate && x.endTime) {
      const s = combineDateTime(x.startDate, x.startTime);
      const ed = combineDateTime(x.endDate, x.endTime);
  ...
  async function submit(e) {
    ...
    const startAt = combineDateTime(m.startDate, m.startTime);
    const endAt = combineDateTime(m.endDate, m.endTime);
